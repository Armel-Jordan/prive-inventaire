        ...
        <div className="flex-1 space-y-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Longueur de la partie numérique</label>
                <select
              ...
              <div className="md:col-span-2">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Le système génère automatiquement le prochain numéro disponible</p>
                  </div>
                </label>
              </div>
            ...
            <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-sm text-gray-500">→ Exemple: {activeConfig.format_exemple}</div>
              </div>
            ...
            <div className="mt-4 p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {[1, 2, 3, 10, 100, 999].map(n => {
                  ...
                  return (
                    <span key={n} className="px-3 py-1 bg-gray-100 dark:bg-gray-600 rounded font-mono text-sm dark:text-white">
